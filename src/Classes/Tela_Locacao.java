...
public class Tela_Locacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MENU LOCAÇÃO IMÓVEIS");
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        x.locacao(jTextFieldCodigo.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Locacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
